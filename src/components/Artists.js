...
const Artist = ({img, name, role, children}) => {
...
export default ({api}) => (
  <div className="padder artists">
    <Artist name="Laura Hopwood" img="images/lh.jpg" role="performer">
    ...
    <Artist name="Meret Roth" img="images/mr.jpg" role="singer">
    ...
    <Artist name="Lucas Jordan" img="images/lj.jpg" role="flute and composition">
    ...
    <Artist name="Elena Cappelletti" img="images/ec.jpg" role="cello">
    ...
    <Artist name="Irene Ros" img="images/ir.jpg" role="theatre director">
    ...
    <Artist name="Marja-Lisa Hedenquist" img="images/mlh.jpg" role="costume design">
