...
const Artist = memo(({img, name, role, children, api}) => {
  const [visible, setVisible] = useState(false);
  const show = useCallback(() => {
    setVisible(true)
    api.setAllowScrolling(false)
  }, [api, setVisible])
  const hide = useCallback((e) => {console.log('fukc')
    setVisible(false)
...
export default memo(({api}) => (
  <div className="padder artists">
    <Artist api={api} name="Laura Hopwood" img="images/lh.jpg" role="performer">
    ...
    <Artist api={api} name="Meret Roth" img="images/mr.jpg" role="singer">
    ...
    <Artist api={api} name="Lucas Jordan" img="images/lj.jpg" role="flute and composition">
    ...
    <Artist api={api} name="Elena Cappelletti" img="images/ec.jpg" role="cello">
    ...
    <Artist api={api} name="Irene Ros" img="images/ir.jpg" role="theatre director">
    ...
    <Artist api={api} name="Marja-Lisa Hedenquist" img="images/mlh.jpg" role="costume design">
